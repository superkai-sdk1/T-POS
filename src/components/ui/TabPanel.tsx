...
export function TabPanel({ id, activeTab, prevTab, tabOrder, children }: TabPanelProps) {
  ...
  return (
    <div
      className={isActive ? `flex-1 flex flex-col min-h-0 min-w-0 overflow-y-auto overflow-x-hidden overscroll-contain scroll-area ${id === 'pos' ? 'lg:overflow-hidden' : ''} ${animClass}` : 'hidden'}
