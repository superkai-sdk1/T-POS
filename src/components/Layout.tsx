    ...
    <div className="min-h-screen bg-[var(--tg-theme-bg-color,#0f0f23)] flex flex-col lg:flex-row">
      ...
      >
        <div className="flex items-center gap-3 px-5 py-5">
          <div className="w-10 h-10 rounded-xl bg-[var(--tg-theme-button-color,#6c5ce7)]/20 flex items-center justify-center">
            <span className="text-base font-black text-[var(--tg-theme-button-color,#6c5ce7)]">T</span>
          </div>
          <div>
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`
                ...
                ${activeTab === tab.id
                  ? 'bg-[var(--tg-theme-button-color,#6c5ce7)]/15 text-[var(--tg-theme-button-color,#6c5ce7)]'
      ...
      <div className="flex-1 flex flex-col lg:ml-64">
        {/* Mobile header */}
        <header
          className="lg:hidden sticky top-0 z-40 px-4 py-3 bg-[var(--tg-theme-secondary-bg-color,#1a1a2e)]/95 backdrop-blur-xl border-b border-white/5"
        ...
        <main
          className="flex-1 px-4 py-4 lg:px-8 lg:py-6 max-w-5xl mx-auto w-full pb-mobile-nav"
        >
          {children}
        </main>
        ...
        {/* Mobile bottom nav */}
        <nav
          className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-[var(--tg-theme-secondary-bg-color,#1a1a2e)]/95 backdrop-blur-xl border-t border-white/5"
