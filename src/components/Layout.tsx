    ...
    <div className="min-h-[100dvh] h-full flex flex-col lg:flex-row overflow-hidden relative" style={{ backgroundColor: 'var(--c-bg)' }}>
      ...
      >
        ...
        <main
          ...
          style={{ WebkitOverflowScrolling: 'touch', paddingBottom: '53px' }}
        >
        ...
        {typeof document !== 'undefined' && createPortal(
          <nav className="lg:hidden fixed left-0 right-0 bottom-0 z-[60] h-[49px] bg-[#0d0d12] backdrop-blur-2xl border-t border-white/5 px-6 sm:px-12">
            <div className="flex w-full max-w-3xl mx-auto items-center justify-between h-full">
              {tabs.map((tab) => {
                const isActive = activeTab === tab.id;
                return (
                  <button
